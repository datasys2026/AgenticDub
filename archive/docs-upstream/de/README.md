...
Sie können Fragen auf dem [Deepwiki von AgenticDub](https://deepwiki.com/krillinai/AgenticDub) stellen. Es indiziert die Dateien im Repository, sodass Sie schnell Antworten finden können.

### Grundlegende Schritte

Laden Sie zunächst die ausführbare Datei herunter, die mit Ihrem Gerätesystem von der [Release](https://github.com/AgenticDub/AgenticDub/releases) übereinstimmt, und folgen Sie dann dem Tutorial unten, um zwischen der Desktop-Version oder der Nicht-Desktop-Version zu wählen. Platzieren Sie den Software-Download in einem leeren Ordner, da beim Ausführen einige Verzeichnisse generiert werden, und das Halten in einem leeren Ordner erleichtert die Verwaltung.
...
1. Öffnen Sie das Terminal im Verzeichnis, in dem sich die ausführbare Datei (angenommen, der Dateiname ist AgenticDub_1.0.0_desktop_macOS_arm64) befindet
...
1. Öffnen Sie das Terminal im Verzeichnis, in dem sich die ausführbare Datei (angenommen, der Dateiname ist AgenticDub_1.0.0_macOS_arm64) befindet
2. Führen Sie die folgenden Befehle der Reihe nach aus:
   ```
...
Docker-Bereitstellung ist derzeit ein legacy / nicht verifizierter Pfad und bleibt nur als Referenz erhalten; bitte beziehen Sie sich auf die [Docker-Bereitstellungsanweisungen](./docker.md)
...
[![Star-Historien-Diagramm](https://api.star-history.com/svg?repos=AgenticDub/AgenticDub&type=Date)](https://star-history.com/#AgenticDub/AgenticDub&Date)
